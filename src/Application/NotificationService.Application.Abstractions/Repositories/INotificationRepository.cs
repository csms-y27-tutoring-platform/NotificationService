...
public interface INotificationRepository
{
    ...
    public Task<IReadOnlyCollection<Notification>> FindByUserIdAsync(Guid userId, CancellationToken cancellationToken);

    public Task<IReadOnlyCollection<Notification>> FindUnreadByUserIdAsync(Guid userId, CancellationToken cancellationToken);
    ...
    public Task<int> CountUnreadByUserIdAsync(Guid userId, CancellationToken cancellationToken);
}